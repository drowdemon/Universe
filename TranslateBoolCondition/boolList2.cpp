...
bool boolList2::AND(bool a, bool b)
{
    return a&&b;
}
bool boolList2::OR(bool a, bool b)
{
    return a||b;
}
bool (* boolList2::ops[2])(bool, bool) = {boolList2::AND, boolList2::OR};
boolList2::boolList2()
{
}

tuple<int*, int*, foo*> boolList2::run(tuple<int*, int*, foo*> data)
{
    vector<bool> res;
...
bool boolList2::helper(tuple<int*, int*, foo*> data, int condInd)
{
...
template<class T>
bool boolList2::helper2(T &datapoint, tuple<int*, int*, foo*> data, int condInd)
{
...
bool boolList2::helper3(T1& datapoint, T2& datapoint2, int condInd)
{
