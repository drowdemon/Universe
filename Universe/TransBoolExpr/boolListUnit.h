...
#ifndef BOOLLISTUNIT_H
#define	BOOLLISTUNIT_H
...
public:
    ...
    unitTuple run(unitTuple data);
    bool helper(unitTuple data, int condInd);
    
    template<class T>
    bool helper2(T &datapoint, unitTuple data, int condInd);
    template<class T1, class T2>
    bool helper3(T1 &datapoint, T2 &datapoint2, int condInd);
    boolListUnit();
};

#endif	/* BOOLLISTUNIT_H */